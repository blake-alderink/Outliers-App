...
const newOutlier = await pool.query('INSERT INTO outliers (outlier_line, average_line, bookmaker, bet_id) VALUES($1,$2,$3,$4)', [betting_line, average_line, bookmaker, bet_id])
